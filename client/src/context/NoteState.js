...
const NoteState = (props) => {
    ...
    const getNotes = (currentTab) => {
        setLoading(true);
        const url = (process.env.NODE_ENV === "development")?`${baseUrl}/api/note/readnote?fetch=${currentTab}` : `/api/note/readnote?fetch=${currentTab}`;
    ...
    const getArchiveNotesOfLabel = (currentTab) => {
        setLoading(true);
        const url = (process.env.NODE_ENV === "development")?`${baseUrl}/api/note/readArchiveNote?fetch=${currentTab}`:`/api/note/readArchiveNote?fetch=${currentTab}`;
        // const url = `/api/note/readnote`;
        fetch(url, {
            method: "get",
            headers: {
    ...
    const addNotes = (noteData,currentTab) => {
        ...
        setLoading(true);
        const url = (process.env.NODE_ENV === "development")?`${baseUrl}/api/note/createnote` : "/api/note/createnote";
        fetch(url, {
            method: "post",
            headers: {
                "Content-Type": "application/json",
    ...
    const updateNote = (updatedData, noteId, currentTab) => {
        ...
        console.log(noteId);
        setLoading(true);
        const url = (process.env.NODE_ENV === "development")?`${baseUrl}/api/note/updatenote/${noteId}`:`/api/note/updatenote/${noteId}`;
        fetch(url, {
            method: "PATCH",
            headers: {
                "Content-Type": "application/json",
    ...
    const updateManyNote = (updatedData,oldLabel,operation,currentTab) => {
        ...
        const url = (process.env.NODE_ENV === "development")?`${baseUrl}/api/note/updateManyNote`:`/api/note/updateManyNote`;
        fetch(url, {
            method: "PATCH",
            headers: {
                "Content-Type": "application/json",
    ...
    const deleteNote = (noteId,currentTab) => {
        setLoading(true);
        const url = (process.env.NODE_ENV === "development")?`${baseUrl}/api/note/deletenote/${noteId}`:`/api/note/deletenote/${noteId}`;
        fetch(url, {
            method: "DELETE",
            headers: {
                "Content-Type": "application/json",
    ...
    const addUser = (userData,first,second,third,fourth) => {
        setLoading(true);
        const url = (process.env.NODE_ENV === "development")?`${baseUrl}/api/user/signup`:"/api/user/signup";
        fetch(url, {
            method: "post",
            headers: {
                "Content-Type": "application/json",
    ...
    const loginUser = (loginUserData,first,second) => {
        setLoading(true);
        const url = (process.env.NODE_ENV === "development")?`${baseUrl}/api/user/login`:"/api/user/login";
        fetch(url, {
            method: "post",
            headers: {
                "Content-Type": "application/json"
    ...
    const addUserLabel = (labelName,oldName) => {
        setLoading(true);        
        const url = (process.env.NODE_ENV === "development")?`${baseUrl}/api/user/createLabel`:"/api/user/createLabel";
        const lName = {
    ...
    const getLabels = () => {
        setLoading(true);
        const url = (process.env.NODE_ENV === "development")?`${baseUrl}/api/user/getuser`:"/api/user/getuser";
        fetch(url, {
            method: "GET",
            headers: {
                "Content-Type": "application/json",
    ...
    const updateNoteCollaborators = (updatedData, currentTab) => {
        ...
        const url = (process.env.NODE_ENV === "development")?`${baseUrl}/api/note/updatenote/${selectedNoteId}/collaborators`:`/api/note/updatenote/${selectedNoteId}/collaborators`;
        fetch(url, {
            method: "PATCH",
            headers: {
                "Content-Type": "application/json",
    ...
    const removeNoteCollaborators = (updatedData, currentTab) => {
        ...
        console.log(updatedData);
        console.log(selectedNoteId);
        const url = (process.env.NODE_ENV === "development")?`${baseUrl}/api/note/updatenote/${selectedNoteId}/removeCol`:`/api/note/updatenote/${selectedNoteId}/removeCol`;
        fetch(url, {
            method: "PATCH",
            headers: {
                "Content-Type": "application/json",
    ...
    const updateColor = (updatedData,currentTab) => {
        setLoading(true);
        const url = (process.env.NODE_ENV === "development")?`${baseUrl}/api/note/updatenote/${selectedNoteId}`:`/api/note/updatenote/${selectedNoteId}`;
        console.log(updatedData);
        fetch(url, {
            method: "PATCH",
            headers: {
